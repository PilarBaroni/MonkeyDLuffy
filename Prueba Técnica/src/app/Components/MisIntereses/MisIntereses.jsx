...
export const MisIntereses = () => {
    ...
    return (
        <div className={styles.carrousel}>
            ...
            <div className={`${margarine.className} ${styles.arrowLeft}`} onClick={handlePrevClick}>&lt;</div>
            <div className={`${margarine.className} ${styles.grande}`} style={{ transform: `translateX(-${currentIndex * 100 / images.length}%)` }}>
            ...
            <div className={`${margarine.className} ${styles.arrowRight}`} onClick={handleNextClick}>&gt;</div>
